...
const Popup = () => {
  ...
  return (
    <div className="mx-auto  flex flex-col gap-y-4 p-4 w-64 h-1/4  bg-white  shadow-sky-900 rounded-md border ">
      <div className="container  space-y-1">
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            <img src={setting} alt="Settings" className="w-6 h-4" />
            <img src={close} alt="Close" className="w-6 h-4" />
          </div>
        </div>
        <div className="text-gray-700  text-xs">
          This extension helps you record and share help videos with ease.
        </div>
        <div className="flex space-x-8 text-gray-700 font-semibold mb-4">
          <div className="flex items-center space-x-2">
        ...
        <div className="flex flex-col space-y-4 text-sm">
          <div className="flex items-center justify-between border-2 border-primary-600 p-2 rounded-lg">
        ...
        <section className="">
          {recording ? (
            <button
              ...
              className="bg-red-500 p-[8px] text-white w-[100%] rounded-[12px]"
            >
              Stop Recording
            </button>
          ) : (
            <button
              ...
              className="bg-[#120B48] p-[8px] text-white w-[100%] rounded-[12px]"
            >
              Start Recording
            </button>
          )}
